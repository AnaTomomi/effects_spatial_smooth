function my_NBS_test_craddock30(idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
savepath= sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD07/NBS/NBS_sphere_Craddock30_%smm_F-test_%s_Fisher_2019.mat',smoothing,thres);
...
data_path=sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD07/NBS/temp/sphere_craddock30_%smm.mat',smoothing);
