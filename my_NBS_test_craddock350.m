function my_NBS_test_craddock350(idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
test='F-test';
N = 329; %number of ROIs 246 Brainnetome, 30, 98, 329 Craddock
...
savepath= sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD07/NBS/NBS_sphere_Craddock350_%smm_F-test_%s_Fisher_2019.mat',smoothing,thres);
...
data_path=sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD07/NBS/temp/sphere_craddock350_%smm.mat',smoothing);
