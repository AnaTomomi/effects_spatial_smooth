...
name='Adj_NoThr_Craddock3007.mat';
name2='Correlation_Craddock3007.mat';
%name3='Craddock30.mat';
parcel='roi_craddock3007_ts_all_rois.mat';
...
for i=1:length(subjects)
    ...
    Idx=find(FD>0.7); %finds which FD is over 0.5 There is another FD below!
