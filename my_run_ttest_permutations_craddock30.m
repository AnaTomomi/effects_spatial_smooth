function my_run_ttest_permutations_craddock30(idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% savepath= sprintf('/m/cs/scratch/networks/data/ABIDE_II/Analysis/ABIDE_extended/Permutations/Craddock30/links_%smm_%s',smoothing,strrep(thr,'.',''));
...
savepath= sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD05/Permutations/Craddock30/links_%smm_%s.mat',smoothing,strrep(thr,'.',''));
...
group1= dir(folder1);
group1= group1(3:end); group1= group1(6:16:end);
group2= dir(folder2);
group2= group2(3:end); group2= group2(6:16:end);
