...
atlas1=nii.img(:,:,:,3);%select the atlas with 30 ROIs
atlas2=nii.img(:,:,:,10);%select the atlas with 100 ROIs
atlas3=nii.img(:,:,:,31);%select the atlas with 350 ROIs

nii_path = '/m/cs/scratch/networks/trianaa1/Atlas/Craddock_random_30.nii';
...
save_nii(make_nii(atlas3, [x y z]), nii_path)