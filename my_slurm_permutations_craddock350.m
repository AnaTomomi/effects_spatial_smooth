function my_slurm_permutations_craddock350(idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
savepath='/m/cs/scratch/networks/data/ABIDE_II/Analysis/ABIDE_extended/Permutations/Craddock350';


group1=dir(folder1); group1=group1(3:end); group1=group1(8:16:end);
group2=dir(folder2); group2=group2(3:end); group2=group2(8:16:end);
