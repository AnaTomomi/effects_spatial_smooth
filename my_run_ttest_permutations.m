...
savepath= sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD05/Permutations/Brainnetome/links_%smm_%s.mat',smoothing,strrep(thr,'.',''));
...
group1= dir(folder1);
group1= group1(3:end); group1= group1(2:16:end);
group2= dir(folder2);
