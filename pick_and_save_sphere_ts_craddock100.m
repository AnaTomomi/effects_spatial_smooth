...
function cfg = pick_and_save_sphere_ts_craddock100(cfg)
...
if strcmp(cfg.adjacency_rois{1}, 'all')
    roi_voxel_ts_info_name = ['sphere_craddock10007_ts_all_rois_info.mat'];%roi_voxel_ts_info_name = ['roi_voxel_ts_all_rois_info.mat'];
    roi_voxel_ts_name = ['sphere_craddock10007_ts_all_rois.mat'];%roi_voxel_ts_name = ['roi_voxel_ts_all_rois.mat'];
else
    roi_voxel_ts_info_name = ['sphere_craddock10007_ts_voxel_info.mat'];%roi_voxel_ts_info_name = ['roi_voxel_ts_info.mat'];
    roi_voxel_ts_name = ['sphere_craddock10007_ts_voxel.mat'];%roi_voxel_ts_name = ['roi_voxel_ts.mat'];
end
