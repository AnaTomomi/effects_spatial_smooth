function my_run_ttest_permutations_craddock350(idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% savepath= sprintf('/m/cs/scratch/networks/data/ABIDE_II/Analysis/ABIDE_extended/Permutations/Craddock350/weightedlinks_%smm_%s',smoothing,strrep(thr,'.',''));
...
savepath= sprintf('/m/cs/scratch/networks/data/UCLA_openneuro/Analysis/FD05/Permutations/Craddock350/links_%smm_%s.mat',smoothing,strrep(thr,'.',''));
...
group1= dir(folder1);
group1= group1(3:end); group1= group1(8:16:end);
group2= dir(folder2);
